...
namespace AmmoboxPlus.Projectiles {
    public class RocketStarburst : ModProjectile {
        ...
        public override void AI() {
            ...
            if(!(shotFrom == ItemID.ProximityMineLauncher && projectile.ai[1] >= 3)) Dust.NewDustPerfect(projectile.Center - new Vector2(0, projectile.height/2), DustID.GoldCoin);
        ...
        public override void Kill(int timeLeft) {
            int shotFrom = projectile.GetGlobalProjectile<AmmoboxGlobalProjectile>(mod).apShotFromLauncherID;
            AmmoboxHelpfulMethods.createBurst(ProjectileID.FallingStar, projectile.identity, projectile.owner, 40);
